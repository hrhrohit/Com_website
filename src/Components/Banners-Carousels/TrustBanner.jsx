        ...
        <>
            <div className="frame-2">
                ...
                <div className="frame-3">
                    <img className="hodu-light-logo" alt="Hodu light logo" src="/img/hodu-light-logo-300x96-1-1.png" />
                    <img className="PC-w" alt="Pc w" src="/img/pc-w-1-1.svg" />
                    <img className="img-3" alt="Img" src="/img/65546b3ead9395d0b0aacee9-croo-logo-1.svg" />
